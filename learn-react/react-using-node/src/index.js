...
import Shoe from "./adidas-shoe.png";
import Football from "./adidas-football.png";
import Perfume from './adidas_perfume.png';
import Jacket from "./adidas-jackets.png";
import Bags from './adidas-bags.png';
import Jackets from "./adidas-jacket-mens-black.png";
import Hockey from "./adidas-hockey-stick.png";
import Track from  "./adidas-tracks.png";

const Header = () => {
    return (
        <nav className="header">
            <img className="header--logo" src={Logo} alt="Adidas Logo"/>
...
const CardData = [
    { img:Shoe, name:"Adidas Shoe", price:50 },
    { img:Football, name:"Adidas Football", price:350.75 },
    { img:Perfume, name:"Adidas Perfume", price:150 },
    { img:Jacket, name:"Adidas Jackets", price:200.50 },
    { img:Bags, name:"Adidas Bags", price:170.0 },
    { img:Jackets, name:"Adidas Jacket", price:50 },
    { img:Hockey, name:"Adidas Hockey Stick", price:50 },
    { img:Track, name:"Adidas Track Suits", price:50 }]
